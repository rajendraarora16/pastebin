		...
		<div id="content_frame">
			...
			<span style="padding: 10px;"><i class="fa fa-tags"></i> New Paste</span>
				<div class="textarea_border">
					<textarea id="paste_code" class="paste_textarea" name="paste_code" style="resize: none; overflow-y: auto; height: 300px;" name="paste_code" placeholder="Paste your source code here.." required="required"><%=source_codes%></textarea>
				</div>
				<div style="padding: 10px;">
					<input type="text" name="title_code" value="<%=title%>" placeholder="Enter title here.." required="required"/>
				</div>
